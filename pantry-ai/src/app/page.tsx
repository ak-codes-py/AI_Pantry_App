...
const Page = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 min-h-screen bg-cover bg-center" style={{ backgroundImage: 'url(https://i.pinimg.com/originals/da/24/dd/da24dd4512e3ef96adc79fb3ad2849ab.gif)' }}>
      <div className="bg-white bg-opacity-75 p-8 rounded-lg shadow-lg h-full">
        <h1 className="text-2xl font-bold mb-4">Pantry Tracking</h1>
      ...
      <div className="w-full px-8 overflow-auto mt-2">
          ...
          <tbody>
            {inventory.map(item => (
              <tr key={item.id}>
                ...
                <td className="py-2 px-4 border-b text-center">${item.msrp.toFixed(2)}</td>
